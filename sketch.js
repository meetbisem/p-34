...
function preload() {
  ...
  backg=loadImage("gamingbackground2.png");
  mon=loadImage("monster.png");
  mons=loadImage("monster1.png");
  monst=loadImage("monster2.png");
  sph=loadImage("superhero.png");
  sph1=loadImage("superhero1.png");
  sph2=loadImage("superhero2.png");
